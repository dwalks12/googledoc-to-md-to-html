function onOpen() {
  DocumentApp.getUi().createAddonMenu().addItem('Convert To HTML', 'showSidebar').addToUi();
}

function showSidebar() {
 var html = HtmlService.createTemplateFromFile("index").evaluate().setTitle("Convert To HTML");
...
function ConvertToMarkdown() {
  ...
  return { html: text, title: DocumentApp.getActiveDocument().getName() };
}
